...
***ES todo:  make this more democratic between prelu and gelu since the latter's self-consistent results are also in, i.e. add gelu code and update readme and documentation to indicate both options ***
